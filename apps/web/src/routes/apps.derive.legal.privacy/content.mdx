...
The mobile application (App) refers to the Dérive iOS application available through the Apple App Store. The App provides interactive features including photography challenges, photo collection, and exploration-related features.

The website refers to all public-facing informational pages on [builder.group/apps/derive](https://builder.group/apps/derive). This includes content such as homepage, about us, contact information, product descriptions, and support resources.
...
- App Data: Photos, challenge progress, and preferences stored locally on your device
...
The App requires access to your camera and photo library to function properly. When you grant these permissions, the App can:

- Capture photos using your device camera
- Access photos from your library for use in challenges
- Store photos locally on your device

**Important:** All photos are processed and stored locally on your device. We do not transmit, store, or access your photos through our servers. All photo functionality operates entirely on your device, and you can revoke camera or photo library access at any time through your iOS Settings.
