...
The mobile application (App) refers to the Kairos iOS application available through the Apple App Store. The App provides a random interval timer for meditation, exercise, study sessions, and games.

The website refers to all public-facing informational pages on [builder.group/apps/kairos](https://builder.group/apps/kairos). This includes content such as homepage, about us, contact information, product descriptions, and support resources.
...
- App Data: Timer settings and preferences stored locally on your device
...
The App uses local notifications to fire the alarm when the timer ends. These notifications are scheduled entirely on your device and are never sent to our servers. You can revoke notification permission at any time through your iOS Settings.
