...
_Effective January 7, 2026_

## Using Dérive Means Accepting These Terms

These Terms of Service (the "Terms"), in conjunction with our Privacy Policy, constitute the entire Agreement between Benno Kohrs (Sole Proprietor Business) ("Benno Kohrs", "we", "us", or "our") and you ("you", "your" or the "User"). These Terms govern your use of the Dérive mobile application (the "App") with bundle identifier `com.buildergroup.Derive`, available on the Apple App Store, and the website [builder.group/apps/derive](https://builder.group/apps/derive) and all its subdomains (collectively, the "Service").
...
Dérive offers a free service option. We may offer paid license options in the future that provide access to an extended set of features. The specifics of these features for each plan will be disclosed in the App and on our website.

### License Grant

Upon downloading and installing the App, Users are granted a non-exclusive, non-transferable right to use Dérive for personal, non-commercial purposes. If we introduce paid license options in the future, Users will be granted a non-exclusive, non-transferable, and time-limited right to use Dérive's extended features. This license is assigned to your device and may not be shared or transferred without our explicit permission.
