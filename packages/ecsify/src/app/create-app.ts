...
>(config: TCreateAppConfig<GPlugins, GAppContext>): TApp<GAppContext> {
	...
	const app: TApp<GAppContext> = {
		...
		c: {} as GAppContext['components'],
		r: {} as GAppContext['resources'],
	...
	app._queryRegistry = createQueryRegistry(app._entityIndex, app._componentRegistry);
