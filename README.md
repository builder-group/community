...
| [try-results](https://github.com/builder-group/community/blob/develop/packages/try-results)                       | A minimal, functional, and tree-shakable Result library for TypeScript that prioritizes simplicity and serialization                                                           | [`try-results`](https://www.npmjs.com/package/try-results)                       |
