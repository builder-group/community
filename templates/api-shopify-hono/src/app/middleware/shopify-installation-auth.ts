...
import {
	authenticateShopifyInstallation,
	invalidateShopifyOfflineAccessToken,
	type ShopifyInstallationCx
} from '@/modules/shopify';

export const shopifyInstallationAuth = createMiddleware<{
	Variables: { shopifyInstallationCx: ShopifyInstallationCx };
}>(async (context, next) => {
	...
	const [isShopifyInstallationCxOk, shopifyInstallationCxErr, shopifyInstallationCx] =
